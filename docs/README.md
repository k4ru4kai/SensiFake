...
Tutti i comandi delle guide si eseguono dalla radice del repository.

| Documento | Quando usarlo |
|---|---|
| [Annotazione offline](offline_annotation.md) | Preparare, annotare e restituire pacchetti locali |
| [Workflow dettagliati](workflows.md) | Raccolta dati, app condivisa, importazione ed esportazioni |
| [Manifest e audit](data_manifest.md) | Provenienza, conteggi documentati e limiti dei dati |
| [Protocollo](dataset_protocol.md) | Ruoli sperimentali e split |
